...
public class Audio extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        recordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecording){
                    stopRecording();
                    recordBtn.setImageDrawable(getResources().getDrawable(R.mipmap.ic_media_pause, null));
                    isRecording = false;
                }else {
                    if (checkPermission()) {
                        startRecording();
                        recordBtn.setImageDrawable(getResources().getDrawable(R.mipmap.ic_media_play, null));
                        isRecording = true;
                    }
                }
            }
    ...
    private void startRecording() {
        ...
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy, MM, dd, mm_ss");
        Date now = new Date();
